...
class RevLayerKeras(keras.layers.Layer):
    def __init__(self,
        ...
        self.F_conv1 = tf.keras.layers.Conv1D(filters=self.channels_x2,
                                           kernel_size=3,
                                           padding='same',
                                           strides=1)
        self.F_relu2 = tf.keras.layers.ReLU()
        self.F_bn2 = tf.keras.layers.BatchNormalization()
        self.F_conv2 = tf.keras.layers.Conv1D(filters=self.channels_x1,
                                              kernel_size=3,
                                              padding='same',
                                              strides=1)
        # Define G layers
        ...
        self.G_conv1 = tf.keras.layers.Conv1D(filters=self.channels_x1,
                                              kernel_size=3,
                                              padding='same',
                                              strides=1)
        self.G_relu2 = tf.keras.layers.ReLU()
        self.G_bn2 = tf.keras.layers.BatchNormalization()
        self.G_conv2 = tf.keras.layers.Conv1D(filters=self.channels_x2,
                                              kernel_size=3,
                                              padding='same',
                                              strides=1)
    ...
    def call(self, x, **kwargs):
        ...
        F_x2 = self.F_conv2(self.F_relu2(self.F_bn2(self.F_conv1(self.F_relu1(self.F_bn1(x2))))))
        y1 = tf.add(x1, F_x2)
